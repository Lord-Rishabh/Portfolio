...
const Navbar = () => {
    ...
    return (
        <nav className=" bg-[#232332] p-5  h-[12vh] font-extrabold pl-20 max-sm:px-8 flex items-center justify-between mx-auto sticky font-sans" id="#home">
            ...
            <div className={`text-xl bg-[#232332] text-white  flex flex-col gap-6 py-3 items-center absolute top-[55px] left-0 w-full lg:flex-row lg:static lg:justify-end lg:items-center lg:pr-12 ${isMenuOpen ? '' : 'max-lg:hidden '} `}>
