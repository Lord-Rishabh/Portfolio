...
const Navbar = () => {
    ...
    return (
        <nav className=" bg-[#232332] p-5  h-[12vh] font-extrabold pl-20 max-sm:px-8 flex items-center justify-between mx-auto sticky font-sans" id="#home">

            <div className="z-10" >
                <h1 className="text-white text-3xl">WEB<span className="text-[#50dfa8]">DEV</span></h1>
            </div>

            <div className={`text-xl bg-[#232332] text-white  flex flex-col gap-6 py-3 items-center font-bold absolute top-[55px] left-0 w-full lg:flex-row lg:static lg:justify-end lg:items-center lg:pr-12 ${isMenuOpen ? '' : 'max-lg:hidden '} `}>
                ...
                <ScrollLink to="#contact" spy={true} smooth={true} offset={-70} duration={500} className=" hover:scale-110 hover:duration-150 hover:cursor-default duration-150 lg:pl-12">
                <button type="button" className="text-white bg-[#3182ce] font-semibold rounded-full text-lg max-md:text-sm px-5 py-2.5 text-center ">Contact Me</button>
                </ScrollLink>
            </div>
